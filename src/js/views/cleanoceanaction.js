...
export const CleanOceanAction = () => (
	<div className="container col-6">
		...
		<p className="paragraph">
			...
			business, community, conservation, diving, environmental, fishing, religious, service, student, surfing, and
			womens groups. COA works with these Ocean Wavemakers to clean up and protect the waters of the New York
			Bight from Montauk, NY, to Cape May, NJ. With continuous, relentless efforts COA uses research, education,
			and citizen action to empower people and convince our elected officials to protect our marine resources for
