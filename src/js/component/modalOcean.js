			...
			<div className="modal-dialog" role="document">
				<div className="modal-content">
					<div className="modal-header">
						<h3 className="modal-title">Clean Ocean Action! GREAT CHOICE!!</h3>
						{props.onClose ? (
							<button
					...
					<div className="modal-footer mx-auto">
						<a
							type="button"
							href="https://secure.donationpay.org/cleanoceanaction/"
							target="_blank"
