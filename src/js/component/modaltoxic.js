			...
			<div className="modal-dialog" role="document">
				<div className="modal-content">
					<div className="modal-header">
						<h3 className="modal-title">Toxic Free Future! GREAT CHOICE!!</h3>
						{props.onClose ? (
							<button
					...
					<div className="modal-footer mx-auto">
						<a
							type="button"
							href="https://toxicfreefuture.org/make-your-impact-today/"
							target="_blank"
